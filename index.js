...
function getStatusDescriptiveText(color) {
  return color == "nodata"
    ? "Nem állnak rendelkezésre adatok: állapotfelmérés nem történt."
    : color == "success"
    ? "Ezen a napon nem rögzítettek állásidőt."
    : color == "failure"
    ? "Jelentősebb kieséseket rögzítettek ezen a napon."
    : color == "partial"
    ? "Részleges leállások ezen a napon."
    : "Ismeretlen";
}
